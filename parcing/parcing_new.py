...
def updating_table_signed():
    ...
    timer.start(500)  # Start the timer for updating labels
...
if __name__ == '__main__':
    ...
    timer.timeout.connect(updating_table_unsigned)
    timer.timeout.connect(updating_table_signed)
    # timer.timeout.connect(updating_table_unsigned)
    ...
    form.pushButton_6.clicked.connect(stop_timer)
